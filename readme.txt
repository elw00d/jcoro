...
13. Сделать тест на unpatchables + reflection.

Ещё идея: сделать плагинчик для винды, который правой кнопкой делает javap для класса и открывает его
в сконфигурированном редакторе (например, в EditPlus)